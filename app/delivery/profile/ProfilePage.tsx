...
import { DOCUMENT_SLOTS } from "./util"
      ...
      <div className="space-y-6 p-4 max-w-3xl">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage your company profile and submit verification documents
          </p>
        </div>
        ...
        <Card className="p-6">
          ...
          <p className="text-sm text-muted-foreground mb-6">
            Upload your company registration and insurance certificate to verify your account.
          </p>
