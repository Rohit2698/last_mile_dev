    ...
    <header className="sticky flex justify-center top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <nav className="hidden md:flex items-center gap-6">
          <a href="#dispensary" className="text-sm font-medium transition-colors hover:text-primary">
            Dispensary
          </a>
          <a href="#delivery-partner" className="text-sm font-medium transition-colors hover:text-primary">
            Delivery Partner
          </a>
